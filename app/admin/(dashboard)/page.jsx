    ...
    <>
      <Reveal variant="up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div key={idx} className="bg-white border border-lightgray rounded-2xl p-6 shadow-card flex flex-col">
              <span className="font-mono text-[11px] uppercase tracking-wider text-cloud mb-2">
                {metric.label}
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white border border-lightgray rounded-2xl p-6 shadow-card min-h-[400px] flex flex-col">
            <h3 className="font-display font-bold text-lg text-graphite mb-6">User Acquisition Trend (30 Days)</h3>
            <div className="flex-1 flex items-center justify-center relative">
              {/* CSS Mock Chart Grid */}
              <div className="absolute inset-0 flex flex-col justify-between py-4">
                {[...Array(5)].map((_, i) =>
                <div key={i} className="border-b border-lightgray/30 w-full h-0"></div>
                )}
              </div>
              ...
              <div className="absolute inset-0 pt-4 px-4 flex items-end justify-between gap-2">
                ...
                <div key={i} className="w-full bg-graphite/20 rounded-t-sm relative group transition-all hover:bg-graphite/40" style={{ height: `${height}%` }}>
                    <div className="absolute -top-1 left-0 right-0 h-1 bg-graphite rounded-t-sm"></div>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="animate-pulse flex space-x-4">
                  <div className="flex-1 space-y-4 py-1">
                    ...
                    <div className="h-2 bg-lightgray rounded w-5/6"></div>
                    <div className="h-2 bg-lightgray rounded"></div>
                  </div>
                </div> :
                ...
                return (
                  <div key={idx}>
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm font-medium text-graphite truncate pr-2">{source.sourceMedium}</span>
